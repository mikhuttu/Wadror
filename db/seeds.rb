...
b4 = Brewery.create name:"Laitila", year:1995
...
b1.beers.create name:"Tuplahumala", style: s2.id
b2.beers.create name:"Huvila Pale Ale", style: s3.id
b2.beers.create name:"X Porter", style: s4.id
b3.beers.create name:"Hefezeizen", style: s2.id
b3.beers.create name:"Helles", style: s4.id
b4.beers.create name:"Kukko", style: s1.id
